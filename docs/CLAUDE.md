...
- `src/lib/` - Integration functions (includes Better Auth, Stripe)
...
**Styling**: Uses Tailwind CSS v4 with the Vite plugin. Shadcn components are configured with "new-york" style, Stone base color, and CSS variables enabled.
