...
export const Route = createFileRoute('/admin/bookings/current-bookings')({
	head: () => ({
		meta: [
			{
				title: 'Current & Upcoming Bookings | Irishette.com',
			},
		],
	}),
...
function AdminBookings() {
	...
	// Filter to only show current and upcoming bookings (checkout date is today or future)
	...
	return (
		<AdminLayout title="Current & Upcoming Bookings">
			<div className="mb-6">
				<p className="text-muted-foreground">
					Manage and view current and upcoming property bookings
				</p>
			</div>
			...
			<Card className="max-w-full overflow-hidden">
				<CardHeader>
					<div className="flex items-center justify-between">
						<CardTitle>
							Current Bookings ({table.getFilteredRowModel().rows.length})
						</CardTitle>
