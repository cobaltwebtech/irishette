/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 6c69a297b567c03ac8c3ad975c11382c)
// Runtime types generated with workerd@1.20251109.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_TURNSTILE_PUBLIC_KEY: string;
		BETTER_AUTH_URL: string;
		BETTER_AUTH_SECRET: string;
		STRIPE_PUBLISHABLE_KEY: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_BETTER_AUTH_WEBHOOK_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_TURNSTILE_PUBLIC_KEY" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_BETTER_AUTH_WEBHOOK_SECRET" | "STRIPE_TRPC_WEBHOOK_SECRET" | "RESEND_API_KEY" | "TURNSTILE_SECRET_KEY" | "TURNSTILE_PUBLIC_KEY">> {}
}
